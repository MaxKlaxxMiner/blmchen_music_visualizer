 ...
 * identical.
 *******************************************************************************/
SWB_OFFSET_1024_96 = new Uint16Array([
...
SWB_OFFSET_128_96 = new Uint16Array([
    0, 4, 8, 12, 16, 20, 24, 32, 40, 48, 64, 92, 128
]);

SWB_OFFSET_1024_64 = new Uint16Array([
      0, 4, 8, 12, 16, 20, 24, 28,
     32, 36, 40, 44, 48, 52, 56, 64,
...
SWB_OFFSET_128_64 = new Uint16Array([
    0, 4, 8, 12, 16, 20, 24, 32, 40, 48, 64, 92, 128
]);

SWB_OFFSET_1024_48 = new Uint16Array([
      0, 4, 8, 12, 16, 20, 24, 28,
...
SWB_OFFSET_128_48 = new Uint16Array([
     0, 4, 8, 12, 16, 20, 28, 36,
    44, 56, 68, 80, 96, 112, 128
]);

SWB_OFFSET_1024_32 = new Uint16Array([
      0, 4, 8, 12, 16, 20, 24, 28,
     32, 36, 40, 48, 56, 64, 72, 80,
     88, 96, 108, 120, 132, 144, 160, 176,
    196, 216, 240, 264, 292, 320, 352, 384,
...
SWB_OFFSET_1024_24 = new Uint16Array([
      0, 4, 8, 12, 16, 20, 24, 28,
...
SWB_OFFSET_128_24 = new Uint16Array([
     0, 4, 8, 12, 16, 20, 24, 28,
    36, 44, 52, 64, 76, 92, 108, 128
]);

SWB_OFFSET_1024_16 = new Uint16Array([
...
SWB_OFFSET_128_16 = new Uint16Array([
     0, 4, 8, 12, 16, 20, 24, 28,
    32, 40, 48, 60, 72, 88, 108, 128
]);

SWB_OFFSET_1024_8 = new Uint16Array([
...
SWB_OFFSET_128_8 = new Uint16Array([
     0, 4, 8, 12, 16, 20, 24, 28,
